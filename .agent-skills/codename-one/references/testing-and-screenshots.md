...
```
~/.codenameone/<package.pooproject>/   (Mac/Linux)
%APPDATA%\.codenameone\<package.pooproject>\   (Windows)
```
...
rm ~/.codenameone/com.github.project.pooproject/settings-screen.png
