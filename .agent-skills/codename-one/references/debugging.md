...
| Command | Purpose |
| --- | --- |
| `stop in com.github.project.pooproject.runApp` | Breakpoint on a method entry. |
| `stop at com.github.project.LoginForm:42` | Breakpoint at source line 42. |
...
5. **Set the breakpoint, then continue**: at the `jdb >` prompt:
   ...
   ```
   stop at com.github.project.LoginForm:42
   cont
   ```
